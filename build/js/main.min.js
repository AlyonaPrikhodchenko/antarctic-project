...
/* harmony import */ var _modules_project_burger__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/project/burger */ "./js/modules/project/burger.js");
/* harmony import */ var _modules_project_validation__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/project/validation */ "./js/modules/project/validation.js");
/* harmony import */ var _modules_project_map_open__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/project/map-open */ "./js/modules/project/map-open.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  if (form) {
    Object(_modules_project_validation__WEBPACK_IMPORTED_MODULE_3__["initForm"])(form);
  }
  Object(_modules_project_map_open__WEBPACK_IMPORTED_MODULE_4__["openFrameMap"])();
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_project_burger__WEBPACK_IMPORTED_MODULE_2__["initBurgerMenu"])();
  });
});
...
var initBurgerMenu = function initBurgerMenu() {
  ...
  var mobileContent = document.querySelector('.header__menu-wrapper');
  var mobileLogo = document.querySelector('.logo__image');
  ...
  if (burger) {
    ...
    mobileContent.addEventListener('click', function (evt) {
...
/*!****************************************!*\
  !*** ./js/modules/project/map-open.js ***!
  \****************************************/
/*! exports provided: openFrameMap */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "openFrameMap", function() { return openFrameMap; });
var openFrameMap = function openFrameMap() {
  var map = document.querySelector('.contacts-map__interactive');
  var mapImage = document.querySelector('.contacts-map__image-wrapper');
  if (map) {
...
/*!****************************************!*\
  !*** ./js/modules/project/mask-tel.js ***!
  \****************************************/
/*! exports provided: makeMaskPhoneNumber */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "makeMaskPhoneNumber", function() { return makeMaskPhoneNumber; });
var makeMaskPhoneNumber = function makeMaskPhoneNumber(form) {
  ...
  if (tel) {
    ...
    var onPhonePaste = function onPhonePaste(evt) {
      var pasted = evt.clipboardData || window.Clipboard;
      var input = evt.target;
      var inputNumbersValue = getInputNumbersValue(input);
      if (pasted) {
        var pastedText = pasted.getData('text/plain');
...
/*!**************************************************!*\
  !*** ./js/modules/project/reset-default-form.js ***!
  \**************************************************/
/*! exports provided: resetDefaultForm */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "resetDefaultForm", function() { return resetDefaultForm; });
var resetDefaultForm = function resetDefaultForm(form) {
  var formBlock = form.querySelector('form');
  if (form) {
...
/* harmony import */ var _mask_tel_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./mask-tel.js */ "./js/modules/project/mask-tel.js");
/* harmony import */ var _reset_default_form_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./reset-default-form.js */ "./js/modules/project/reset-default-form.js");


var initForm = function initForm(myForm) {
  if (myForm) {
    Object(_mask_tel_js__WEBPACK_IMPORTED_MODULE_0__["makeMaskPhoneNumber"])(myForm);
    Object(_reset_default_form_js__WEBPACK_IMPORTED_MODULE_1__["resetDefaultForm"])(myForm);
  }
};
